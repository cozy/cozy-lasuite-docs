# How to contribute to  cozy-lasuite-docs?
...
- What is the version of the  cozy-lasuite-docs app?
...
```
$ git clone github.com/cozy/ cozy-lasuite-docs.git
$ cd  cozy-lasuite-docs
$ git remote add fork git://github.com/yourusername/ cozy-lasuite-docs.git
```
...
Go to https://github.com/yourusername/ cozy-lasuite-docs and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-lasuite-docs is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-lasuite-docs/issues/new
...
[localization]: https://github.com/cozy/ cozy-lasuite-docs/blob/master/README.md#localization
